...
#define LED1 D1  // Pemilihan Pin D0
#define LED2 D0   // Pemilihan Pin D1

const char* ssid = "wifi";       // Nama SSID AP/Hotspot
...
void setup() {  // Pengaturan Pin
  ...
  server.on("/LED1ON", []() {
    ...
    digitalWrite(LED2, LOW);  // Mematikan LED2 ketika LED1 dinyalakan
  });
  server.on("/LED2ON", []() {
    server.send(200, "text/html", webpage);
    digitalWrite(LED2, HIGH);
    digitalWrite(LED1, LOW);  // Mematikan LED1 ketika LED2 dinyalakan
  });
